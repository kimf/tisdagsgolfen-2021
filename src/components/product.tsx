...
function Product({ id, name }) {
  const { data, mutate } = useSWR(
    ...
    (query, id) => request("https://api-eu-central-1.graphcms.com/v2/ck8sn5tnf01gc01z89dbc7s0o/master", query, { id }),
  ...
  async function handleClick() {
    ...
    mutate({ ...data, productVotes: { aggregate: { count: newCount } } }, false)
